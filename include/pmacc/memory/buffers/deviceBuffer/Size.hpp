...
namespace pmacc
{
    namespace mem
    {
        namespace device_buffer
        {
            ...
            struct DeviceBufferSize : buffer::BufferSize<T_dim>
            {
                void create_size_on_device()
                {
                    ...
                    this->device_current_size
                        = rg::IOResource<size_t>(std::shared_ptr<size_t>(device_size_ptr, [](size_t* ptr) {
                    ...
                    if(device_current_size)
                        Environment<>::task(
                            [new_size](auto host_size, auto device_size) {
                                ...
                                (1, 1, 0, redGrapes::thread::current_cupla_stream)(device_size.get(), new_size);
                            },
            ...
            protected:
                ...
                std::optional<rg::IOResource<size_t>> device_current_size;
            };
