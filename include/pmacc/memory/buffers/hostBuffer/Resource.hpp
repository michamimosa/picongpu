    ...
    namespace mem
    {
        namespace host_buffer
        {
            ...
            namespace data
            {
                ...
                using ReadGuard = buffer::data::ReadGuard<HostBufferResource<T_Item, T_dim, T_DataAccessPolicy>>;

                template<typename T_Item, std::size_t T_dim, typename T_DataAccessPolicy = rg::access::IOAccess>
                using WriteGuard = buffer::data::WriteGuard<HostBufferResource<T_Item, T_dim, T_DataAccessPolicy>>;
            } // namespace data

            namespace size
            {
                template<typename T_Item, std::size_t T_dim, typename T_DataAccessPolicy = rg::access::IOAccess>
                using ReadGuard = buffer::size::ReadGuard<HostBufferResource<T_Item, T_dim, T_DataAccessPolicy>>;

                template<typename T_Item, std::size_t T_dim, typename T_DataAccessPolicy = rg::access::IOAccess>
                using WriteGuard = buffer::size::WriteGuard<HostBufferResource<T_Item, T_dim, T_DataAccessPolicy>>;
            } // namespace size


            template<typename T_Item, std::size_t T_dim, typename T_DataAccessPolicy = rg::access::IOAccess>
            struct HostBufferResource
                : protected rg::SharedResourceObject<HostBufferData<T_Item, T_dim>, T_DataAccessPolicy>
            {
                using Item = T_Item;
                ...
                HostBufferResource(DataSpace<dim> capacity)
                    : rg::SharedResourceObject<Data, DataAccessPolicy>(std::make_shared<Data>(capacity))
                {
                }
            ...
            template<typename T_Item, std::size_t T_dim, typename T_DataAccessPolicy = rg::access::IOAccess>
            using ReadGuard = buffer::ReadGuard<HostBufferResource<T_Item, T_dim, T_DataAccessPolicy>>;

            template<typename T_Item, std::size_t T_dim, typename T_DataAccessPolicy = rg::access::IOAccess>
            using WriteGuard = buffer::WriteGuard<HostBufferResource<T_Item, T_dim, T_DataAccessPolicy>>;
